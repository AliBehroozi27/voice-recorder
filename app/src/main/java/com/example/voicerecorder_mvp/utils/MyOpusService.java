...
public class MyOpusService extends Service {
    
    private String TAG = MyOpusService.class.getName();
    
    //Looper
    private volatile Looper mServiceLooper;
    private volatile MyOpusService.ServiceHandler mServiceHandler;
    ...
    public static void play(Context context, String fileName) {
        Intent intent = new Intent(context, MyOpusService.class);
    ...
    public void onCreate() {
        ...
        mServiceHandler = new MyOpusService.ServiceHandler(mServiceLooper);
